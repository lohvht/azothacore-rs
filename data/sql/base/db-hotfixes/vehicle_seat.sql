...
CREATE TABLE `vehicle_seat` (
  ...
  `AttachmentOffset1` float NOT NULL DEFAULT 0,
  `AttachmentOffset2` float NOT NULL DEFAULT 0,
  `AttachmentOffset3` float NOT NULL DEFAULT 0,
  ...
  `CameraOffset1` float NOT NULL DEFAULT 0,
  `CameraOffset2` float NOT NULL DEFAULT 0,
  `CameraOffset3` float NOT NULL DEFAULT 0,
