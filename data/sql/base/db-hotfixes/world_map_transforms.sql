...
CREATE TABLE `world_map_transforms` (
  ...
  `RegionMinMax1` float NOT NULL DEFAULT 0,
  `RegionMinMax2` float NOT NULL DEFAULT 0,
  `RegionMinMax3` float NOT NULL DEFAULT 0,
  `RegionMinMax4` float NOT NULL DEFAULT 0,
  `RegionMinMax5` float NOT NULL DEFAULT 0,
  `RegionMinMax6` float NOT NULL DEFAULT 0,
  `RegionOffset1` float NOT NULL DEFAULT 0,
  `RegionOffset2` float NOT NULL DEFAULT 0,
