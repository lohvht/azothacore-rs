...
LOCK TABLES `conversation_actor_template` WRITE;
/*!40000 ALTER TABLE `conversation_actor_template` DISABLE KEYS */;
/*!40000 ALTER TABLE `conversation_actor_template` ENABLE KEYS */;
UNLOCK TABLES;
