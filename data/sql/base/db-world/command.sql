...
CREATE TABLE `command` (
  ...
  PRIMARY KEY (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Chat System';
...
('reload config',630,'Syntax: .reload config\r\n\r\nReload config settings (by default stored in config). Not all settings can be change at reload: some new setting values will be ignored until restart, some values will applied with delay or only to new objects/maps, some values will explicitly rejected to change at reload.'),
...
('reload internal_server_strings',704,'Syntax: .reload internal_server_strings\nReload internal_server_strings table.'),
...
('whispers',471,'Syntax: .whispers on|off\r\nEnable/disable accepting whispers by GM from players. By default use core setting.'),
