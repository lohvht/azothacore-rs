...
LOCK TABLES `conversation_line_template` WRITE;
/*!40000 ALTER TABLE `conversation_line_template` DISABLE KEYS */;
/*!40000 ALTER TABLE `conversation_line_template` ENABLE KEYS */;
UNLOCK TABLES;
